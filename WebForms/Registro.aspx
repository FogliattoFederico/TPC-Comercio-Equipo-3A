...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlRegistrar" runat="server" DefaultButton="btnRegistrar">
        <div style="max-width: 500px; margin: 40px auto; padding: 40px; background: linear-gradient(145deg, #ffffff, #f5f7fa); border-radius: 12px; box-shadow: 0 8px 20px rgba(0,0,0,0.08); font-family: 'Segoe UI', Arial, sans-serif;">
            <h2 style="text-align: center; margin-bottom: 25px; color: #2c3e50; font-weight: 600; font-size: 28px;">Registrarse</h2>
            ...
            <div style="display: flex; flex-direction: column; gap: 20px; margin-bottom: 20px;">
                ...
                <div>
                    <asp:Label ID="lblNombre" runat="server" Text="Nombre" Style="display: block; margin-bottom: 5px; color: #7f8c8d; font-size: 16px; font-weight: 500;"></asp:Label>
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" Width="100%"
                        Style="padding: 10px; border: 1px solid #ddd; border-radius: 6px; background-color: #f8f9fa; color: #95a5a6;" />
                </div>
                <div>
                    <asp:Label ID="lblApellido" runat="server" Text="Apellido" Style="display: block; margin-bottom: 5px; color: #7f8c8d; font-size: 16px; font-weight: 500;"></asp:Label>
            ...
            <div style="display: flex; gap: 15px; margin-top: 30px;">
                <asp:Button ID="btnRegistrar" runat="server" Text="Registrarse" OnClick="btnRegistrar_Click1"
